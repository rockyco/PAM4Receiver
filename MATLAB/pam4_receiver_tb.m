function pam4_receiver_tb()
    ...
    % Note: Visualization functionality has been removed for simplified testing
    ...
    % Data collection arrays for core testing only
    ...
    for block = 1:num_blocks
        ...
        % Continue with coefficient tracking
    ...
    % Visualization functionality removed - testbench now focuses on core testing only
